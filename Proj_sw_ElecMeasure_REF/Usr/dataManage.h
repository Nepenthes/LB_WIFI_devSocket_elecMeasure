...
#define		SMARTSWITCH_IF					 0			//是否为 老版APP

#if(SMARTSWITCH_IF != 1)
#define 	SWITCH_TYPE_FP	 				 0x07		//开关类型，电量检测插座-smart_living
#else
#define 	SWITCH_TYPE_FP	 				 0x21		//开关类型，电量检测插座-smart_switch
#endif
...
#define		EEPROM_ADDR_serverIP_record    	 0x0030   	//30H - 35H 服务器IP存储+端口				06_Byte
